...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if($resultado){
        header('Location: /SystemLybrary/templates/Socios/ListaSocio.php');
    }else{
            ...
            <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/SystemLybrary/templates/Socios/ModificarSocio.php" method='POST'>
                                ...
                                <div class="modal-footer">
                                    <a name="" id="" class="btn btn-secondary" href="/SystemLybrary/templates/Socios/ListaSocio.php" role="button">Cancelar</a>
