...
$resultado = mysqli_query(conectarDB(), $query);
        ...
        if($resultado && $resultado2){
            ...
            header('Location: /SystemLybrary/Biblioteca_Control/templates/Reparaciones/ListaReparacion.php');
        }else{
            echo 'Revisar SQL';
        }
 ...
 <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <form action="/SystemLybrary/templates/Reparaciones/AltaReparacion.php" method='POST'>
                    ...
                    <div class="modal-footer">
                        <a name="" id="" class="btn btn-secondary" href="/SystemLybrary/templates/Reparaciones/ListaReparacion.php" role="button">Cancelar</a>
