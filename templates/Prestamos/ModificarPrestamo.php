...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if($resultado){
        ...
        if($resultado){
                ...
                if ($resultado){
                    header('Location: /SystemLybrary/templates/Prestamos/DetallePrestamo.php?id=' . $cod_prestamo);
        ...
        <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="/SystemLybrary/templates/Prestamos/ModificarPrestamo.php" method="post">
                        ...
                        <div class="modal-footer">
                            <a name="" id="" class="btn btn-primary" href="/SystemLybrary/templates/Prestamos/DetallePrestamo.php?id=<?php echo $res['cod_prestamo']?>" role="button">Cancelar</a>
