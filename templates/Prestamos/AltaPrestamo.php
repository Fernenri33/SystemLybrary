    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if($resultado2){
            ...
            if(isset($_POST['agregarOtro'])){
                header('Location: /SystemLybrary/templates/Prestamos/AltaPrestamo.php?fun=add');
            }else{
 ...
 <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <form action="/SystemLybrary/templates/Prestamos/AltaPrestamo.php" method='POST'>
                ...
                <div class="modal-footer">
                    ...
                    <?php if (isset($_GET['fun'])){?>
                    <a name="" id="" class="btn btn-danger" href="/SystemLybrary/templates/Prestamos/ListaPrestamos.php" role="button">Terminé!</a>
                    <?php }else{?>
                    <a name="" id="" class="btn btn-secondary" href="/SystemLybrary/templates/Prestamos/ListaPrestamos.php" role="button">Cancelar</a>
                    <?php }?>
